...
object Bip86Test extends TestSuite {
    ...
    val tests = Tests {
        test("BIP86 reference test") {
            ...
            assertEquals(internalKey.value, ByteVector32.fromValidHex("cc8a4bc64d897bddc5fbc2f670f7a8ba0b386779106cf1223c6fc5d7cd6fc115"))
            val outputKey = internalKey.outputKey(merkleRoot = None)
            assertEquals(outputKey.value, ByteVector32.fromValidHex("a60869f0dbcf1dc659c9cecbaf8050135ea9e8cdc487053f1dc6880949dc684c"))
            val script = List(OP_1, OP_PUSHDATA(outputKey.value))
            assertEquals(Script.write(script), ByteVector.fromValidHex("5120a60869f0dbcf1dc659c9cecbaf8050135ea9e8cdc487053f1dc6880949dc684c"))
            ...
            assertEquals(internalKey1.value, ByteVector32.fromValidHex("83dfe85a3151d2517290da461fe2815591ef69f2b18a2ce63f01697a8b313145"))
            val outputKey1 = internalKey1.outputKey(merkleRoot = None)
            assertEquals(outputKey1.value, ByteVector32.fromValidHex("a82f29944d65b86ae6b5e5cc75e294ead6c59391a1edc5e016e3498c67fc7bbb"))
            val script1 = List(OP_1, OP_PUSHDATA(outputKey1.value))
            assertEquals(Script.write(script1), ByteVector.fromValidHex("5120a82f29944d65b86ae6b5e5cc75e294ead6c59391a1edc5e016e3498c67fc7bbb"))
            ...
            assertEquals(internalKey2.value, ByteVector32.fromValidHex("399f1b2f4393f29a18c937859c5dd8a77350103157eb880f02e8c08214277cef"))
            val outputKey2 = internalKey2.outputKey(merkleRoot = None)
            assertEquals(outputKey2.value, ByteVector32.fromValidHex("882d74e5d0572d5a816cef0041a96b6c1de832f6f9676d9605c44d5e9a97d3dc"))
            val script2 = List(OP_1, OP_PUSHDATA(outputKey2.value))
            assertEquals(Script.write(script2), ByteVector.fromValidHex("5120882d74e5d0572d5a816cef0041a96b6c1de832f6f9676d9605c44d5e9a97d3dc"))
        }
