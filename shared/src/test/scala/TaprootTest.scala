...
object TaprootTest extends TestSuite {
    ...
    val tests = Tests {
        test("check taproot signatures") {
            ...
            val hash = Transaction.hashForSigningSchnorr(tx1, 0, List(tx.txOut.head), sighashType, SigVersion.SIGVERSION_TAPROOT)
        ...
        test("send to and spend from taproot addresses") {
            ...
            val sigHashType = 0
            val hash = Transaction.hashForSigningSchnorr(tx1, 0, List(tx.txOut(1)), sigHashType, SigVersion.SIGVERSION_TAPROOT)
            ...
            val hash2 = Transaction.hashForSigningSchnorr(tx2,0, List(tx.txOut(1)), sigHashType2, SigVersion.SIGVERSION_TAPROOT)
        ...
        test("spend pay-to-taproot transactions - 1") {
            ...
            Transaction.correctlySpends(tx2, List(tx1), ScriptFlags.STANDARD_SCRIPT_VERIFY_FLAGS)
        }
        ...
        test("spend pay-to-taproot transactions - 2") {
            ...
            Transaction.correctlySpends(tx, List(parent), ScriptFlags.STANDARD_SCRIPT_VERIFY_FLAGS)
        }
        ...
        test("spend pay-to-tapscript transactions (OP_CHECKSIGADD 1)") {
            val inputs = List(
                Transaction.read(""),
            ...
            val tx = Transaction.read("")
        ...
        test("use OP_CHECKSIGADD to implement multisig") {
            ...
            val script = List(
                OP_PUSHDATA(privs(0).publicKey.xonly), OP_CHECKSIG,
                OP_PUSHDATA(privs(1).publicKey.xonly), OP_CHECKSIGADD,
                OP_PUSHDATA(privs(2).publicKey.xonly), OP_CHECKSIGADD,
